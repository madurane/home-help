package loft.repository;

import loft.HomehelpApp;
import loft.config.Constants;
import loft.config.audit.AuditEventConverter;
import loft.domain.PersistentAuditEvent;
...
import static loft.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
